...
import SalesManagerLayout from '../../../components/SalesManagerLayout'; // Reusing layout for now
        ...
        <SalesManagerLayout>
            <div style={{ padding: '32px', maxWidth: '1600px', margin: '0 auto' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'end', marginBottom: '32px' }}>
                    <div>
                        <h1 style={{ fontSize: '32px', fontWeight: '800', color: '#111', marginBottom: '8px', letterSpacing: '-0.5px' }}>
                            Executive Overview
                        </h1>
                    ...
                    <div style={{ display: 'flex', gap: '12px' }}>
                        ...
                        <button style={{ padding: '10px 20px', background: '#111', border: 'none', borderRadius: '8px', fontWeight: '600', color: '#FFF', cursor: 'pointer' }}>
                            Live View
                        </button>
                    </div>
                </div>
                    ...
                    <div style={{ background: '#FFF', padding: '24px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.04)', position: 'relative', overflow: 'hidden' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                            <div>
                                ...
                                <div style={{ fontSize: '36px', fontWeight: '800', color: '#111', letterSpacing: '-1px' }}>{metrics.revenue.value}</div>
                            ...
                            <RevenueIcon color="#111" opacity={0.1} />
                        </div>
                    </div>
                    ...
                    <div style={{ background: '#FFF', padding: '24px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.04)', position: 'relative', overflow: 'hidden' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                            <div>
                                ...
                                <div style={{ fontSize: '36px', fontWeight: '800', color: '#111', letterSpacing: '-1px' }}>{metrics.pipeline.value}</div>
                    ...
                    <div style={{ background: '#FFF', padding: '24px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.04)', position: 'relative', overflow: 'hidden' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                            <div>
                                ...
                                <div style={{ fontSize: '36px', fontWeight: '800', color: '#111', letterSpacing: '-1px' }}>{metrics.conversion.value}</div>
                    ...
                    <div style={{ background: '#FFF', padding: '24px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.04)', position: 'relative', overflow: 'hidden' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                            <div>
                                ...
                                <div style={{ fontSize: '36px', fontWeight: '800', color: '#111', letterSpacing: '-1px' }}>{metrics.deals.value}</div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '32px', marginBottom: '32px' }}>
                    ...
                    <div style={{ background: '#FFF', padding: '32px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.04)' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '24px' }}>
                            <h3 style={{ fontSize: '18px', fontWeight: '700', color: '#111' }}>Revenue & Pipeline Trend</h3>
                            <div style={{ display: 'flex', gap: '16px', fontSize: '13px', fontWeight: '600' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}><div style={{ width: 10, height: 10, background: '#111', borderRadius: '2px' }}></div> Revenue</div>
                    ...
                    <div style={{ background: '#FFF', padding: '32px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.04)' }}>
                        <h3 style={{ fontSize: '18px', fontWeight: '700', color: '#111', marginBottom: '24px' }}>Top Performing Regions</h3>
                                ...
                                <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                                    ...
                                    <div style={{ flex: 1 }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                                            <span style={{ fontSize: '14px', fontWeight: '600', color: '#111' }}>{region.state}</span>
                                            <span style={{ fontSize: '14px', fontWeight: '700', color: '#111' }}>{region.count} Leads</span>
                                        </div>
                                        <div style={{ height: '6px', background: '#F5F5F5', borderRadius: '3px', overflow: 'hidden' }}>
                                            <div style={{
                                                width: `${(region.count / (geoData[0]?.count || 1)) * 100}%`,
                                                height: '100%',
                                                background: idx === 0 ? '#111' : '#AAA',
                                                borderRadius: '3px'
                                            }}></div>
                                        </div>
                                    </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px' }}>
                    ...
                    {/* Top Products */}
                    <div style={{ background: '#FFF', padding: '32px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.04)' }}>
                        <h3 style={{ fontSize: '18px', fontWeight: '700', color: '#111', marginBottom: '24px' }}>Product Category Distribution</h3>
                    ...
                    {/* Conversion Funnel */}
                    <div style={{ background: '#FFF', padding: '32px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.04)' }}>
                        <h3 style={{ fontSize: '18px', fontWeight: '700', color: '#111', marginBottom: '24px' }}>Conversion Funnel Efficiency</h3>
                        <div style={{ height: '250px' }}>
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={funnelData} layout="vertical" margin={{ left: 20 }}>
                                    ...
                                    <Tooltip />
                                    <Bar dataKey="count" fill="#111" radius={[0, 4, 4, 0]} barSize={32}>
                                        {funnelData.map((entry, index) => (
                                            <Cell key={`cell-${index}`} fill={entry.name === 'Won' ? '#28A745' : '#111'} opacity={entry.name === 'Won' ? 1 : 0.2 + (index * 0.2)} />
                                        ))}
                                    </Bar>
                                </BarChart>
                            </ResponsiveContainer>
